...
public class ScreenBg_LinearLayout extends LinearLayout {
    ...
    public ScreenBg_LinearLayout(@NonNull Context context) {
        super(context);
        init(context);
    }

    public ScreenBg_LinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ScreenBg_LinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
