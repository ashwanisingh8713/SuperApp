...
public class CompanyBseData implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.snapShot, 0);
    }

    public CompanyBseData() {
    }

    protected CompanyBseData(Parcel in) {
    ...
    public static final Parcelable.Creator<CompanyBseData> CREATOR = new Parcelable.Creator<CompanyBseData>() {
        public CompanyBseData createFromParcel(Parcel source) {
            return new CompanyBseData(source);
        }

        public CompanyBseData[] newArray(int size) {
            return new CompanyBseData[size];
        }
    };
}
