...
import com.ns.tts.discreteSeekbar.DiscreteSeekBar;
...
public class TTSSettingActivity extends BaseAcitivityTHP {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getDetailToolbar().showBackTitleIcons(getString(R.string.read_aloud), backBtn->{
            finish();
        });
    ...
    protected void onResume() {
        ...
        // Added Google Time Tracking, from Splash to MainActivity
//        GoogleAnalyticsTracker.trackGoogleAnalyticsScreenTimings(TTSSettingActivity.this, GS_TIME_TRACKING_CATEGORY, spentTime(startTime, getEndTime()), "From clicking the TTS setting option", "");
//        AppFirebaseAnalytics.setFirbaseAnalyticsScreenRecord(TTSSettingActivity.this, "TTSSettingActivity Screen", TTSSettingActivity.class.getSimpleName());
    ...
    private void hideSpeedLayout() {
        ...
        mSpeedVisibilityBtn.setImageResource(R.drawable.ic_arrow_drop_down);
    ...
    private void showSpeedLayout() {
        ...
        mSpeedVisibilityBtn.setImageResource(R.drawable.ic_arrow_drop_up);
    ...
    private void hidePitchLayout() {
        ...
        mPitchVisibilityBtn.setImageResource(R.drawable.ic_arrow_drop_down);
    ...
    private void showPitchLayout() {
        ...
        mPitchVisibilityBtn.setImageResource(R.drawable.ic_arrow_drop_up);
...
//            }
    ...
    private void playTTS() {
        final String textString = "This is the hindu read aloud control test voice.";
        if(textToSpeech == null) {
            textToSpeech = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
                @Override
                public void onInit(int status) {
    ...
    public void resetUI(){
        ...
        findViewById(R.id.accentSelectionLayout).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.layout_pitch).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
