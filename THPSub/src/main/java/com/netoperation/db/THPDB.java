...
@Database(entities = {TableSubscriptionArticle.class, TableBookmark.class,
        ...
        TableTemperoryArticle.class, TableMP.class, TableMPReadArticle.class, TableRelatedArticle.class, TableOptional.class},
    ...
    public static THPDB getInstance(Context context) {
        if (INSTANCE == null) {
            synchronized (THPDB.class) {
                if (INSTANCE == null) {
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(), THPDB.class, "THPDB3.db")
