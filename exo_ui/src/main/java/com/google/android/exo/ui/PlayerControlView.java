 ...
 */
package com.google.android.exo.ui;
...
import com.google.android.exo.ExoPlayerLibraryInfo;
import com.google.android.exo.OrientationDetector;
...
import com.google.android.exo.util.RepeatModeUtil;
 ...
 */
public class PlayerControlView extends FrameLayout implements OrientationDetector.OrientationChangeListener {
  ...
  private final View fullScrEnterButton;
  private final View fullScrExitButton;
  ...
  public PlayerControlView(
    ...
    fullScrEnterButton = findViewById(R.id.exo_full_scr_enter);
    if (fullScrEnterButton != null) {
      fullScrEnterButton.setOnClickListener(componentListener);
    }
    fullScrExitButton = findViewById(R.id.exo_full_scr_exit);
    if (fullScrExitButton != null) {
      fullScrExitButton.setOnClickListener(componentListener);
    }
  ...
  private final class ComponentListener extends Player.DefaultEventListener
    ...
    public void onClick(View view) {
      if (player != null) {
        ...
        } else if(fullScrEnterButton == view) {
          setFullscreen(false, ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        } else if(fullScrExitButton == view) {
  ...
  private void fullScreenEnter() {
    fullScrEnterButton.setVisibility(VISIBLE);
    fullScrExitButton.setVisibility(GONE);
  }


  private void fullScreenExit() {
    fullScrEnterButton.setVisibility(GONE);
    fullScrExitButton.setVisibility(VISIBLE);
  }
  ...
  public void onScaleChange(boolean isFullscreen) {
    ...
    playerView.setInLandScape(isFullscreen);
    if (isFullscreen) {
