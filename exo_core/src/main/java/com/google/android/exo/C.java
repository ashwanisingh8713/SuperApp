...
public final class C {
  ...
  /**
   * Content types for {@link AudioAttributes}.
   */
  @Retention(RetentionPolicy.SOURCE)
  ...
  /**
   * Flags for {@link AudioAttributes}.
   * <p>
  ...
  /**
   * Usage types for {@link AudioAttributes}.
   */
  @Retention(RetentionPolicy.SOURCE)
   ...
   * AudioAttributes} instance that will configure the
