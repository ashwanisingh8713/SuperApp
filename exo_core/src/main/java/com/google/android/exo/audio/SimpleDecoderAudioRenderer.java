...
import com.google.android.exo.decoder.SimpleDecoder;
import com.google.android.exo.decoder.SimpleOutputBuffer;
import com.google.android.exo.drm.DrmSession;
import com.google.android.exo.drm.ExoMediaCrypto;
import com.google.android.exo.util.Assertions;
import com.google.android.exo.util.MediaClock;
...
public abstract class SimpleDecoderAudioRenderer extends BaseRenderer implements MediaClock {
  ...
  private void maybeInitDecoder() throws ExoPlaybackException {
    ...
    if (drmSession != null) {
      ...
      if (mediaCrypto == null) {
        DrmSession.DrmSessionException drmError = drmSession.getError();
        if (drmError != null) {
