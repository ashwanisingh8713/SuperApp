...
import com.google.android.exo.extractor.ts.DefaultTsPayloadReaderFactory.Flags;
import com.google.android.exo.util.Assertions;
import com.google.android.exo.util.ParsableBitArray;
...
public final class TsExtractor implements Extractor {
  ...
  private class PmtReader implements SectionPayloadReader {
    ...
    private TsPayloadReader.EsInfo readEsInfo(ParsableByteArray data, int length) {
      ...
      while (data.getPosition() < descriptorsEndPosition) {
        ...
        if (descriptorTag == TS_PMT_DESC_REGISTRATION) { // registration_descriptor
          ...
          while (data.getPosition() < positionOfNextDescriptor) {
            ...
            dvbSubtitleInfos.add(new TsPayloadReader.DvbSubtitleInfo(dvbLanguage, dvbSubtitlingType,
                initializationData));
          }
        }
      ...
      return new TsPayloadReader.EsInfo(streamType, language, dvbSubtitleInfos,
