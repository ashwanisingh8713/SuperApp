...
import com.google.android.exo.extractor.ExtractorOutput;
import com.google.android.exo.extractor.ExtractorsFactory;
import com.google.android.exo.extractor.PositionHolder;
import com.google.android.exo.extractor.SeekMap;
import com.google.android.exo.util.Assertions;
import com.google.android.exo.util.MimeTypes;
import com.google.android.exo.util.NalUnitUtil;
...
import com.google.android.exo.extractor.Extractor;
import com.google.android.exo.extractor.TrackOutput;
import com.google.android.exo.text.cea.CeaUtil;
...
public final class FragmentedMp4Extractor implements Extractor {
  ...
  private void readAtomPayload(ExtractorInput input) throws IOException, InterruptedException {
    ...
    if (atomData != null) {
      ...
      onLeafAtomRead(new Atom.LeafAtom(atomType, atomData), input.getPosition());
    } else {
  ...
  private static void parseMoof(Atom.ContainerAtom moof, SparseArray<TrackBundle> trackBundleArray,
   ...
   */
  private static void parseTraf(Atom.ContainerAtom traf, SparseArray<TrackBundle> trackBundleArray,
                                @Flags int flags, byte[] extendedTypeScratch) throws ParserException {
  ...
  private static void parseTruns(Atom.ContainerAtom traf, TrackBundle trackBundle, long decodeTime,
                                 @Flags int flags) {
    int trunCount = 0;
