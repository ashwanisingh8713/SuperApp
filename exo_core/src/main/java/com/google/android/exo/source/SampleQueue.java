...
import com.google.android.exo.upstream.Allocation;
...
public final class SampleQueue implements TrackOutput {
   ...
   * {@link SampleMetadataQueue.SampleExtrasHolder#size} is adjusted to subtract the number of bytes that were read. The
   * same value is added to {@link SampleMetadataQueue.SampleExtrasHolder#offset}.
   *
