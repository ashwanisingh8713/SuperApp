...
public final class ChunkedTrackBlacklistUtil {
   ...
   * {@link #DEFAULT_TRACK_BLACKLIST_MS} if {@code e} is an {@link HttpDataSource.InvalidResponseCodeException}
   * with {@link HttpDataSource.InvalidResponseCodeException#responseCode} equal to 404 or 410. Else does nothing.
  ...
  /**
   * Returns whether a loading error is an {@link HttpDataSource.InvalidResponseCodeException} with
   * {@link HttpDataSource.InvalidResponseCodeException#responseCode} equal to 404 or 410.
   *
   * @param e The loading error.
   * @return Wheter the loading error is an {@link HttpDataSource.InvalidResponseCodeException} with
   *     {@link HttpDataSource.InvalidResponseCodeException#responseCode} equal to 404 or 410.
   */
