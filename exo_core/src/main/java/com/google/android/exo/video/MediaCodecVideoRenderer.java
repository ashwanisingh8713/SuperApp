 ...
 */
package com.google.android.exo.video;
...
import com.google.android.exo.PlayerMessage;
...
import com.google.android.exo.mediacodec.MediaCodecSelector;
...
import com.google.android.exo.mediacodec.MediaCodecInfo;
import com.google.android.exo.util.Assertions;
import com.google.android.exo.util.TraceUtil;
import com.google.android.exo.video.VideoRendererEventListener.EventDispatcher;
import java.nio.ByteBuffer;

/**
 * Decodes and renders video using {@link MediaCodec}.
 *
 * <p>This renderer accepts the following messages sent via {@link ExoPlayer#createMessage(PlayerMessage.Target)}
...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
  ...
  protected void configureCodec(MediaCodecInfo codecInfo, MediaCodec codec, Format format,
      MediaCrypto crypto) throws MediaCodecUtil.DecoderQueryException {
   ...
   * @throws MediaCodecUtil.DecoderQueryException If an error occurs querying {@code codecInfo}.
   */
  protected CodecMaxValues getCodecMaxValues(MediaCodecInfo codecInfo, Format format,
      Format[] streamFormats) throws MediaCodecUtil.DecoderQueryException {
